...
export default function RegisterRiderPage() {
    ...
    return (_jsxs("div", { className: "flex min-h-screen flex-col bg-zinc-950 px-5 pt-14 pb-10", children: [_jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, className: "absolute top-5 right-5", children: _jsxs("button", { onClick: () => void handleSignOut(), className: "flex items-center gap-1.5 text-xs text-zinc-500 hover:text-zinc-300 transition-colors cursor-pointer", style: { touchAction: 'manipulation' }, children: [_jsx(LogOut, { size: 13 }), "Sign out"] }) }), _jsxs(motion.div, { initial: { opacity: 0, y: 16 }, animate: { opacity: 1, y: 0 }, className: "mb-8", children: [_jsx("div", { className: "mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/15", children: _jsx(Bike, { size: 24, className: "text-primary" }) }), _jsx("h1", { className: "font-display text-2xl font-bold text-zinc-100 leading-tight", children: "Become a rider" }), _jsx("p", { className: "mt-1.5 text-sm text-zinc-500", children: "Join GrandXL and start earning on your schedule" })] }), _jsxs(motion.div, { initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.08 }, className: "mb-5", children: [_jsx("p", { className: "mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500", children: "Your vehicle" }), _jsx("div", { className: "flex flex-col gap-2.5", children: VEHICLES.map(({ type, label, sub, Icon }, i) => {
                            const isSelected = vehicle === type;
                            return (_jsxs(motion.button, { initial: { opacity: 0, x: -10 }, animate: { opacity: 1, x: 0 }, transition: { delay: 0.1 + i * 0.06 }, type: "button", onClick: () => setVehicle(type), className: `flex items-center gap-4 rounded-2xl border px-4 py-4 text-left transition-all duration-200 cursor-pointer ${isSelected
                        ...
                        }) })] }), _jsxs(motion.div, { initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.3 }, className: "mb-8", children: [_jsx("label", { className: "mb-2 block text-xs font-semibold uppercase tracking-wider text-zinc-500", children: "Plate number" }), _jsx("input", { type: "text", value: plate, onChange: (e) => { setPlate(e.target.value); setPlateError(null); }, placeholder: "e.g. ABC-123-XY", className: `w-full rounded-2xl border bg-zinc-900 px-4 py-4 font-mono text-sm tracking-widest text-zinc-100 placeholder-zinc-700 outline-none transition-all duration-200 focus:ring-2 ${plateError
                            ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20'
                            : 'border-zinc-800 focus:border-primary focus:ring-primary/20'}`, style: { fontSize: '16px', touchAction: 'manipulation' }, autoCapitalize: "characters" }), _jsx(AnimatePresence, { children: plateError && (_jsxs(motion.p, { initial: { opacity: 0, y: -4 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0 }, className: "mt-2 flex items-center gap-1.5 text-xs text-red-400", children: [_jsx(AlertCircle, { size: 12 }), plateError] })) })] }), _jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { delay: 0.38 }, className: "mb-8 rounded-2xl border border-zinc-800 bg-zinc-900/60 p-4 text-xs text-zinc-500 leading-relaxed", children: "Your application will be reviewed within 24 hours. We may contact you to verify your vehicle documents." }), _jsx(motion.button, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.42 }, whileTap: { scale: 0.97 }, onClick: () => void handleSubmit(), disabled: loading, className: "mt-auto flex w-full items-center justify-center gap-2 rounded-2xl bg-primary py-4 text-sm font-bold text-white shadow-lg shadow-primary/20 transition-opacity hover:opacity-90 disabled:opacity-60 cursor-pointer", style: { minHeight: '56px', touchAction: 'manipulation' }, children: loading ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "h-4 w-4 rounded-full border-2 border-white/40 border-t-white animate-spin" }), "Submitting\u2026"] })) : (_jsxs(_Fragment, { children: ["Submit application", _jsx(ChevronRight, { size: 18 })] })) })] }));
}
//# sourceMappingURL=RegisterRiderPage.js.map